...
sealed class KshetrajnaDestination(
    ...
    data object Soil : KshetrajnaDestination("soil", "Soil Telemetry", "Soil", Icons.Default.Place)
    data object ManualPH : KshetrajnaDestination("manual_ph", "Manual pH", "Manual pH", Icons.Default.Edit)
    data object Fertility : KshetrajnaDestination("fertility", "Fertility & NPK", "Fertility", Icons.Default.Star)
    data object Weather : KshetrajnaDestination("weather", "Weather Context", "Weather", Icons.Default.Refresh)
    data object Irrigation : KshetrajnaDestination("irrigation", "Irrigation", "Irrigation", Icons.Default.PlayArrow)
